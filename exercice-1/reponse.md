...
une page d'accueil par défaut du serveur web nginx
1.5 Afficher les logs du conteneur "mon-nginx" avec
la commande "docker logs [ID]"
1.6 docker ps -a, elle liste même ceux arrêté (avec "STATUS
Exited")
1.7 docker rm [ID]
